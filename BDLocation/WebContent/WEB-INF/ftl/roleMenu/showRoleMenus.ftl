...
<script type="text/javascript" src="${rc.contextPath}/public/js/system/roleMenu.js"></script>
</head>
<body>
<form id="roleMenuForm" class="form-horizontal">
	<div class="form-group">
        <a  class="btn btn-success" onclick="saveRoleMenu();">
