...
Popup.prototype = {
    ...
    build: function() {
        ...
        var close = '<input type="image"  id="dialogBoxClose" border="0"  width="0" height="0" align="absmiddle" value="" /> ';
        ...
        if (this.config.isHaveTitle) {
            mainBox += '<tr height="1"><td align="right">' + close + '</td></tr>'
    ...
    lastBuild: function() {
        ...
        if (this.config.contentType == 1) {
            var openIframe = "<iframe width='100%' style='height:" + this.config.height + "px' name='" + this.iframeIdName + "' id='" + this.iframeIdName + "' src='" + this.info.contentUrl + "' frameborder='0' allowTransparency='true' scrolling='" + this.config.scrollType + "'></iframe>";
