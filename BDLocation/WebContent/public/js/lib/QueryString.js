...
(function($){
    ...
    $.QueryString = function( queryString, options ){
		...
		this._queryString_ = ( href.lastIndexOf("?") > -1 )? href.substring( href.lastIndexOf("?") + 1, href.length ):null;
		href = ( href.lastIndexOf("?") > -1 )? href.substring( href.lastIndexOf("?") + 1, href.length ).toLowerCase():null;
