...
<body>
	...
	<input type="hidden" id="selfId"  value="${user.id}">
	<input id="selfName" type="hidden" value="客服1号" />
	...
	<!-- 页面宽度是734px 高度是544px-->
<div class="kf_wraper kf_hd">
  <div class="kf_nav fl">
    <div class="kf_name">在线客服系统 v1.0版本</div>
      <li id="customer_list_item_template" style="display:none;">
         <div class="kf_list_img"><img src="<%=basePath2%>public/img/wsImg/client_img.png"></div>
         <div class="kf_list_txt" owename="custItem">
           <p owename="custItemName">在线客户001</p>
           <span owename="custLastDate">17:00 59</span>
         </div>
         <i unread="unreadMessageNumber"></i>
         <b></b>
      </li>
    <ul id="customer_list_region">
  
    <%--   <li>
        <div class="kf_list_img"><img src="<%=basePath2%>resources/image/client_img.png"></div>
        <div class="kf_list_txt">
          <p>在线客户002</p>
          <span>17:00 59</span>
        </div>
        <i>9</i>
  ...
  <div class="kf_wrap fr" >
  
  	<!-- <div class="kf_dialog" style="display:none;" id="message_frame_template">
		<input id="sendTo" type="hidden" value="" />
  	</div> -->
  	...
  	<div class="kf_con kf_client" style="display:none;" id="customer_message_template">
        ...
        <div class="kf_txt">
          <div class="kf_time">
            <span owename="customer_message_name">今天：</span>
   ...
   <div class="kf_con kf_sys" style="display:none;" id="cuservice_message_template">
        ...
        <div class="kf_txt">
          <div class="kf_time">
            ...
            <span owename="cuservice_message_name"> 我  </span>
          </div>
          <div class="kf_box">
            <i></i>
  ...
  <div id="cuservie_message_panel_list">
    <div class="kf_dialog" id="place_position_div"></div>
  
  </div>
 
  <%--   <div class="kf_dialog">
     <!-- 对话开始 -->
      <div class="kf_con kf_client" id="dialogContent">
        <div class="kf_img"><img src="<%=basePath2%>resources/image/client_img.png"></div>
        <div class="kf_txt">
          <div class="kf_time">
            <span>今天：</span>
            <span>09:55:32</span>
      ...
      <div class="kf_con kf_sys">
        <div class="kf_img"><img src="<%=basePath2%>resources/image/sys_img.png"></div>
        <div class="kf_txt">
          <div class="kf_time">
            <span>今天：</span>
            <span>09:55:32</span>
    ...
    <div class="kf_dialog" style="display: none;">2</div>
    <div class="kf_dialog" style="display: none;">3</div>
    <div class="kf_dialog" style="display: none;">4</div>
    <div class="kf_dialog" style="display: none;">5</div>
    <div class="kf_dialog" style="display: none;">6</div>
    <div class="kf_dialog" style="display: none;">7</div>
    <div class="kf_dialog" style="display: none;">8</div>
    <div class="kf_dialog" style="display: none;">9</div>
    <div class="kf_dialog" style="display: none;">10</div> --%>
    ...
    <input type="hidden" id="selfId"  value="${user.id}">
	<input type="hidden" id="selfName" value="客服1号" />
	 <input type="hidden" id="userType"  value="cuservice">
