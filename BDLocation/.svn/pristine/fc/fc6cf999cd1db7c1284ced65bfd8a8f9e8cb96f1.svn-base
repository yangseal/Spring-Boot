...
//详情界面
function orderDetail(corsApplyId,orderType){
	var url = CONTEXT_PATH + "/client/mgtCenter/corsOrders/buyDetailOrder";
	if(orderType == 'rorder')
		url = CONTEXT_PATH + "/client/mgtCenter/corsOrders/repayDetailOrder";
	$.post(url,{"corsApplyId":corsApplyId},function(data){
