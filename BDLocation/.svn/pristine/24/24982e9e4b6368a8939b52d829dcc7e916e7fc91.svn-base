<table width="100%" class="table table-striped table-hover" border="0" cellspacing="0" cellpadding="0">
    <thead>
      <th width="*">入网账号</th>
  ...
  <@common.pager page.pageBean "showRepayDetailOrderForm" "showRepayDetailOrderDiv"/>